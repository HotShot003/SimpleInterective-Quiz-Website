// console.log("hello");
// myarr=['john','paul', 'george', 'ringo','Rango','Gabrial',10,20,30,40,50,60];
// console.log(myarr);
// console.log(myarr[4], myarr[5]);

// let Message = "Battery Low";
// alert(Message);

// let promtmsg="Enter Age";
// prompt(promtmsg);
...
const a = [
  ...
  function nextQuestion() {
    ...
    if (answer === a[currentQuestion].correctAnswer.toString()) { // Corrected to use correctAnswer property
  ...
  // Call loadQuestions to start the quiz
  loadQuestions();
